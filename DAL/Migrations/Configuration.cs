        ...
        protected override void Seed(GeneralDBContext context)
        {
            if (context.Users.FirstOrDefault() == null)
            {
                ...
                context.DevicesTypes.AddRange(new List<DeviceType> {
                    new DeviceType() { Name = DeviceTypeText.PlayStation3, MultiHourPrice = 0, MultiMinutePrice = 0, SingleHourPrice = 0, SingleMinutePrice = 0 },
                    new DeviceType() { Name = DeviceTypeText.PlayStation4, MultiHourPrice = 0, MultiMinutePrice = 0, SingleHourPrice = 0, SingleMinutePrice = 0 },
